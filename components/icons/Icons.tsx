...
export const YoutubeIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path fillRule="evenodd" d="M1.5 4.5a3 3 0 013-3h15a3 3 0 013 3v15a3 3 0 01-3 3h-15a3 3 0 01-3-3v-15zm5.027 2.227c.594-.252 1.25-.252 1.844 0l6.082 2.583a1.5 1.5 0 010 2.82l-6.082 2.583c-.594.252-1.25.252-1.844 0A1.5 1.5 0 016 13.583v-5.166a1.5 1.5 0 01.527-1.12z" clipRule="evenodd" />
  </svg>
);
